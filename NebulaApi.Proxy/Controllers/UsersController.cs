...
[ApiController]
[Route("users")]
public sealed class UsersController(NebulaFastApiService api) : UsersControllerBase(api)
{
    // private readonly NebulaFastApiService _api;
    // public UsersController(NebulaFastApiService api) => _api = api;
    //
    // /// <summary>List all users.</summary>
    // [HttpGet("")]
    // public async Task<IActionResult> List(CancellationToken ct)
    // {
    //     var res = await _api.GetAsync("/users", ct: ct);
    ...
    // {
    //     var res = await _api.PostAsync("/users", body, ct: ct);
    //     return StatusCode(res.StatusCode, res.Body);
    // }
    //
    ...
    // {
    //     var res = await _api.GetAsync($"/users/{Uri.EscapeDataString(name)}", ct: ct);
    //     return StatusCode(res.StatusCode, res.Body);
    // }
    //
    ...
    // {
    //     var res = await _api.GetAsync($"/users/roles/{Uri.EscapeDataString(space)}", ct: ct);
    //     return StatusCode(res.StatusCode, res.Body);
    // }
    //
    ...
    // {
    //     var res = await _api.PostAsync("/users/roles/grant", body, ct: ct);
    //     return StatusCode(res.StatusCode, res.Body);
    // }
    //
    ...
    // {
    //     var res = await _api.PostAsync("/users/roles/revoke", body, ct: ct);
    //     return StatusCode(res.StatusCode, res.Body);
    // }
}
