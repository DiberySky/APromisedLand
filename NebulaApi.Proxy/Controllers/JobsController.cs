...
[ApiController]
[Route("jobs")]
public sealed class JobsController(NebulaFastApiService api) : JobsControllerBase(api)
{
    // private readonly NebulaFastApiService _api;
    // public JobsController(NebulaFastApiService api) => _api = api;
    //
    // /// <summary>Submit a compact job.</summary>
    // [HttpPost("compact")]
    // public async Task<IActionResult> Compact([FromBody] CompactIn body, CancellationToken ct)
    // {
    //     var res = await _api.PostAsync("/jobs/compact", body, ct: ct);
    ...
    // {
    //     var res = await _api.PostAsync("/jobs/flush", body, ct: ct);
    //     return StatusCode(res.StatusCode, res.Body);
    // }
    //
    ...
    // {
    //     var res = await _api.GetAsync("/jobs", ct: ct);
    //     return StatusCode(res.StatusCode, res.Body);
    // }
    //
    ...
    // {
    //     var res = await _api.GetAsync($"/jobs/{jobId}", ct: ct);
    //     return StatusCode(res.StatusCode, res.Body);
    // }
    //
    ...
    // {
    //     var res = await _api.PostAsync($"/jobs/{jobId}/stop", ct: ct);
    //     return StatusCode(res.StatusCode, res.Body);
    // }
    //
    ...
    // {
    //     var res = await _api.PostAsync("/jobs/recover", ct: ct);
    //     return StatusCode(res.StatusCode, res.Body);
    // }
}
