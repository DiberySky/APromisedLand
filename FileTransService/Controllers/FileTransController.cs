using APromisedLand.Api.Projects.SeaweedFS;
...
[ApiController]
[Route("[controller]")]
public class FileTransController(ISeaweedFsService fileTransService, SeaweedFsDbContext db,
    HttpClient client) : SeaweedFsController(fileTransService, db, client)
{
    // [HttpPost("upload")]
