...
using APromisedLand.Api.Projects.Elasticsearch;
...
[ApiController]
[Route("[controller]")]
public class SearchController(ElasticsearchClient client,
    IEmbeddingService embeddingService) : ElasticsearchController(client, embeddingService)
{
