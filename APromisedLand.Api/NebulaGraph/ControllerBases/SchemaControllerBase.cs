...
public abstract class SchemaControllerBase(NebulaFastApiService api) : ControllerBase
{
    ...
    {
        var res = await api.GetAsync(SpacePath(space, "/tags"), ct: ct);
    ...
    {
        body.Space = space;
        var res = await api.PostAsync(SpacePath(space, "/tags"), body, ct: ct);
        return StatusCode(res.StatusCode, res.Body);
    }
    ...
    {
        var res = await api.GetAsync(SpacePath(space, "/edges"), ct: ct);
        return StatusCode(res.StatusCode, res.Body);
    }
    ...
    {
        body.Space = space;
        var res = await api.PostAsync(SpacePath(space, "/edges"), body, ct: ct);
        return StatusCode(res.StatusCode, res.Body);
    }
    ...
    {
        var res = await api.GetAsync(SpacePath(space, "/indexes"), ct: ct);
        return StatusCode(res.StatusCode, res.Body);
    }
    ...
    {
        var res = await api.GetAsync(SpacePath(space, "/indexes/tag"), ct: ct);
        return StatusCode(res.StatusCode, res.Body);
    }
    ...
    {
        var res = await api.GetAsync(SpacePath(space, "/indexes/edge"), ct: ct);
        return StatusCode(res.StatusCode, res.Body);
    }
    ...
    {
        body.Space = space;
        var res = await api.PostAsync(SpacePath(space, "/indexes/tag"), body, ct: ct);
        return StatusCode(res.StatusCode, res.Body);
    }
    ...
    {
        body.Space = space;
        var res = await api.PostAsync(SpacePath(space, "/indexes/edge"), body, ct: ct);
        return StatusCode(res.StatusCode, res.Body);
    }
    ...
    {
        body.Space = space;
        var res = await api.PostAsync(SpacePath(space, "/fulltext-indexes"), body, ct: ct);
        return StatusCode(res.StatusCode, res.Body);
    }
