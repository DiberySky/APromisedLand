...
// /// </summary>
// public class AttributeLocationValueService(DiberyDbContext db, IMemoryCache cache)
// {
//     private const int DedupWindowSeconds = 30;
//     private const string DedupCachePrefix = "Location_Add_Dedup_";
//
//     // ---------- 新增 ----------
//
...
//         var cacheKey = DedupCachePrefix + fingerprint;
//
...
//
//         cache.Set(cacheKey, ((string?)null, (string?)null), TimeSpan.FromSeconds(DedupWindowSeconds));
//
//         var (valueId, error) = await AddInternalAsync(nodeId, dto);
//
//         cache.Set(cacheKey, (valueId, error), TimeSpan.FromSeconds(DedupWindowSeconds));
