...
//
//             var (rowId, error, duplicated) = await valueService.AddRowAsync(nodeId, tableId, tableDefId, dto.Values);
//
//             if (duplicated)
//             {
//                 logger.LogWarning(
...
//         try
//         {
//             var error = await valueService.UpdateRowAsync(rowId, dto.Values);
//             if (!string.IsNullOrEmpty(error))
//                 return BadRequest(ApiResponse<object>.Fail(error));
//
