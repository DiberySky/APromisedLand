...
using APromisedLand.MauiBlazor.Weather;
...
public static class WeatherHttpClient
{
    public static void AddWeatherHttpClient(this MauiAppBuilder builder)
    {
...
//     public static void AddKeycloakClient(this MauiAppBuilder builder)
//     {
