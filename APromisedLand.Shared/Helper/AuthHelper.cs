...
public static class AuthHelper
{
    ...
    public const string KeyCloakPort = "8080";

    public const string YarpkHttpPort = "8088";
    public const string YarpkHttpsPort = "8443";
    ...
    public const string YarpHttpHostAddress = $"http://localhost:{YarpkHttpPort}";
    public const string YarpHttpHostsAddress = $"https://localhost:{YarpkHttpsPort}";
}